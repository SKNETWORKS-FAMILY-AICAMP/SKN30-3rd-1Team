  ...
  > ## 저장소 이관 안내
  >
  > 본 저장소는 **보존용(읽기 전용)** 으로 유지됩니다.
  > 신규 개발, 이슈, PR 및 최신 코드 확인은 아래 저장소에서 진행해 주세요.
  >
  > - **신규 저장소:** [SKN30-4th-1Team](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN30-4th-1Team)
  > - **이관일:** 2026-07-24
  > - **이관 범위:** 전체 커밋 이력, 브랜치 및 태그
  >
  > 기존 저장소에는 신규 변경사항을 반영하지 않습니다.
